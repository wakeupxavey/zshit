...
<div class="zwordle-compact">
  ...
  <div class="compact-row">
    ...
    <button class="word-display-btn" on:click={openModal} aria-label="Open game">
      ...
      <div class="hangman-row">
        <div class="hangman-wrap">
          <svg class="gallows" viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">
            <line x1="5" y1="115" x2="55" y2="115" stroke="#c0b8b8" stroke-width="6" stroke-linecap="round"/>
            <line x1="20" y1="115" x2="20" y2="5" stroke="#c0b8b8" stroke-width="6" stroke-linecap="round"/>
            <line x1="20" y1="5" x2="70" y2="5" stroke="#c0b8b8" stroke-width="6" stroke-linecap="round"/>
            <line x1="70" y1="5" x2="70" y2="18" stroke="#c0b8b8" stroke-width="4" stroke-linecap="round"/>
          </svg>
